...
Level 1 is pure standard-library Python — no dependencies, no GPU, no API keys. Later levels use a
CPU-only PyTorch to build a tiny GPT you can train on a laptop in minutes.
